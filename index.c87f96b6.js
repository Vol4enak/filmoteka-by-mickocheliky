 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),Qn.addEventListener("click",(async e=>{e.preventDefault();const t=Jn.value,i=Yn.value;try{await Bi(io,t,i);oo()}catch(e){no(e)}})),eo.addEventListener("click",Gn),to.addEventListener("click",(async()=>{var e;await(e=io,le(e).signOut())}));
//# sourceMappingURL=index.c87f96b6.js.map
