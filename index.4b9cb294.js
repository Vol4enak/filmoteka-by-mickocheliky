 ...
 * limitations under the License.
 */
const Hn=K("authIdTokenMaxAge")||300;let Vn=null;var Xn;Xn="Browser",He(new ce("auth",((e,{options:t})=>{const i=e.getProvider("app").getImmediate(),n=e.getProvider("heartbeat"),{apiKey:o,authDomain:a}=i.options;return((e,i)=>{ht(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),ht(!(null==a?void 0:a.includes(":")),"argument-error",{appName:e.name});const n={apiKey:o,authDomain:a,clientPlatform:Xn,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:si(Xn)},r=new ci(e,i,n);return function(e,t){const i=(null==t?void 0:t.persistence)||[],n=(Array.isArray(i)?i:[i]).map(xt);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(n,null==t?void 0:t.popupRedirectResolver)}(r,t),r})(i,n)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,i)=>{e.getProvider("auth-internal").initialize()}))),He(new ce("auth-internal",(e=>{const t=di(e.getProvider("auth").getImmediate());return new jn(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ge("@firebase/auth","0.21.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Xn)),Ge("@firebase/auth","0.21.0","esm2017");const qn=document.querySelector(".header-sign-in"),$n=document.querySelector(".sign-popup"),Kn=document.querySelector(".login-cancel-button"),Gn=document.querySelector(".header-my-library");document.querySelector(".header-nav__item-lib");function Jn(){$n.style.display="none",document.body.style.overflow="visible"}qn.addEventListener("click",(function(){$n.style.display="flex",document.body.style.overflow="hidden",document.body.style.height="100%"})),Kn.addEventListener("click",Jn);const Yn=document.querySelector(".sign-popup-email-input"),Qn=document.querySelector(".sign-popup-psw-input"),Zn=document.querySelector(".modal-signup-button"),eo=document.querySelector(".modal-log-in-button"),to=document.querySelector(".login-cancel-button"),io=document.querySelector(".header-sign-out"),no=function(e=Ke()){const t=Ve(e,"auth");if(t.isInitialized())return t.getImmediate();const i=function(e,t){const i=Ve(e,"auth");if(i.isInitialized()){const e=i.getImmediate();if(ee(i.getOptions(),null!=t?t:{}))return e;ut(e,"already-initialized")}return i.initialize({options:t})}(e,{popupRedirectResolver:Fn,persistence:[nn,ji,Vi]}),n=K("authTokenSyncURL");if(n){const e=(o=n,async e=>{const t=e&&await e.getIdTokenResult(),i=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>Hn)return;const n=null==t?void 0:t.token;Vn!==n&&(Vn=n,await fetch(o,{method:n?"POST":"DELETE",headers:n?{Authorization:`Bearer ${n}`}:{}}))});!function(e,t,i){le(e).beforeAuthStateChanged(t,i)}(i,e,(()=>e(i.currentUser))),function(e,t,i,n){le(e).onIdTokenChanged(t,i,n)}(i,(t=>e(t)))}var o;const a=$("auth");return a&&fi(i,`http://${a}`),i}($e({apiKey:"AIzaSyCiganVehDRWNu8DaopL49QNtQWcOnsRz8",authDomain:"filmoteka-3953e.firebaseapp.com",projectId:"filmoteka-3953e",storageBucket:"filmoteka-3953e.appspot.com",messagingSenderId:"570128539922",appId:"1:570128539922:web:4bc967e78fce05a40693cb",measurementId:"G-P61BZ6KQ5V"})),oo=t=>{if("auth/wrong-password"!==t.code)if("auth/email-already-in-use"!==t.code)if("auth/weak-password"!==t.code)if("auth/user-not-found"!==t.code)if("auth/invalid-email"!==t.code){if("auth/too-many-requests"!==t.code)return"auth/internal-error"===t.code?void e(w).Notify.failure("Please provide password"):void e(w).Notify.failure("Error: ${error}");e(w).Notify.failure("Too many requests")}else e(w).Notify.failure("Please provide valid email");else e(w).Notify.failure("There is no user with such email");else e(w).Notify.failure("Password must contain at least 6 characters");else e(w).Notify.failure("This email is already in use");else e(w).Notify.failure("Wrong password. Try again.")},ao=async()=>{var e,t,i;e=e=>{e?(io.classList.remove("visually-hidden"),qn.classList.add("visually-hidden"),ro(),Jn()):(io.classList.add("visually-hidden"),qn.classList.remove("visually-hidden"),ro())},le(no).onAuthStateChanged(e,t,i)};function ro(){qn.classList.contains("visually-hidden")?Gn.setAttribute("href","./my-lib.html"):(Gn.setAttribute("href",""),e(w).Notify.info("Please sign in if you want to use your library"))}ao(),eo.addEventListener("click",(async t=>{t.preventDefault();const i=Yn.value,n=Qn.value;try{await(o=no,a=i,r=n,Wi(le(o),Ni.credential(a,r)));e(w).Notify.success("You signed in"),ao()}catch(e){oo(e)}var o,a,r;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),Zn.addEventListener("click",(async t=>{t.preventDefault();const i=Yn.value,n=Qn.value;try{await Bi(no,i,n);e(w).Notify.success("You signed up"),ao()}catch(e){oo(e)}})),to.addEventListener("click",Jn),io.addEventListener("click",(async()=>{var t;await(t=no,le(t).signOut()),e(w).Notify.success("You logged out")})),document.addEventListener("keydown",(function(e){27===e.keyCode&&Jn()}));
//# sourceMappingURL=index.4b9cb294.js.map
